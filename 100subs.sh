...
echo $red"            harap sabar menunggu yaa zeyenk :v("   
sleep 1
echo '''\a
\033[34;1m                              _
\033[34;1m                             / |
...
echo
echo $pur"==================="$cy" ============================="
echo $i""$pu"  AUTHOR    :  Mr.CDS16  "$i"                  "
echo $i""$pu"  WhatsApp  :  087888023633"$i"              "
echo $i""$pu"  TUJUAN     :  SPESIAL 100 SUBSCRIBERS"$i"   "
echo $i""$pu"  YOUTUBE   :  CHARLEz YT"$i"               "
echo $i""$pu"  INSTAGRAM :  @panda_art016_"$i"               "
echo $pur"==================="$cy" ============================="
echo
...
echo $ku"["$me"10"$ku"]"$i" SPAM WHATSHAPP NEW"
...
sleep 2
echo $i"Support Terus Channel Saya CHARLEz YT"
sleep 2
echo $i"Tools Ini Spesial 100 SUBSCRIBERS"
sleep 2
echo $pur"Bila Ada Kesalahan Anda Bisa Nanya Melalui Via"
sleep 2
echo $ku"Facebook :"$i" Charles David"
echo $ku"YouTube  :"$i" CHARLEz YT"
echo $ku"WhatsApp :"$i" 087888023633"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { CHARLEz YT }"
exit
fi
